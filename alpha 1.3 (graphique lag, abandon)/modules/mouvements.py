...
def melangeur(cube,can,nombre):
	...
	for i in range(nombre):
		can.after(i*timeur,lambda:rotation(cube,can,randint(0,5),choice(["droite","gauche"])))
...
def rotative(cube,can,face,faceSup,norme):
	...
	if norme.upper()=="U":
		can.after(compteur*timeur,lambda:rotationHaut(cube,can,face,faceSup,"gauche"))
	elif norme.upper()=="U'":
		can.after(compteur*timeur,lambda:rotationHaut(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="L":
		can.after(compteur*timeur,lambda:rotationGauche(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="L'":
		can.after(compteur*timeur,lambda:rotationGauche(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="F":
		can.after(compteur*timeur,lambda:rotation(cube,can,face,"droite"))
	elif norme.upper()=="F'":
		can.after(compteur*timeur,lambda:rotation(cube,can,face,"gauche"))
	elif norme.upper()=="R":
		can.after(compteur*timeur,lambda:rotationDroite(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="R'":
		can.after(compteur*timeur,lambda:rotationDroite(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="D":
		can.after(compteur*timeur,lambda:rotationBas(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="D'":
		can.after(compteur*timeur,lambda:rotationBas(cube,can,face,faceSup,"gauche"))
	elif norme.upper()=="M":
		can.after(compteur*timeur,lambda:axe(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="M'":
		can.after(compteur*timeur,lambda:axe(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="E":
		can.after(compteur*timeur,lambda:axe(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="E'":
		can.after(compteur*timeur,lambda:axe(cube,can,face,faceSup,"gauche"))
...
def rotation(cube,can,face,sens):
	...
	rotationAnim(lowCube,cube,can,face,sens)
	actualise(cube,can)

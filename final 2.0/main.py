...
menuAide.add_command(label="Consulter le site web",command=lambda:webbrowser.open('http://yvonus.myds.me/~hugo/index.php'))
menuAide.add_command(label="En savoir plus sur les notations",command=lambda:webbrowser.open('https://ruwix.com/the-rubiks-cube/notation/'))
...
# Création de l'interface permettant de manipuler les faces du cube

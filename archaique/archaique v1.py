...
# initialisation de la liste, les faces vont de 0 à 5 (selon leur indice) et chaque case d'une face est numéroté de 0 à 8
...
can.pack()
actualise(cube,can)
bou1=Button(main, text="mélanger", command=lambda:melangeur(cube,can,5), fg='blue')
bou1.pack()

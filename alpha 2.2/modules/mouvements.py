...
def rotative(cube,can,face,faceSup,norme):
	...
	if norme.upper()=="U":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationHaut(cube,can,face,faceSup,"gauche"))
	elif norme.upper()=="U'":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationHaut(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="L":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationGauche(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="L'":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationGauche(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="F":
		can.after(compteur*rFile("timeur","cub"),lambda:rotation(cube,can,face,"droite"))
	elif norme.upper()=="F'":
		can.after(compteur*rFile("timeur","cub"),lambda:rotation(cube,can,face,"gauche"))
	elif norme.upper()=="R":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationDroite(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="R'":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationDroite(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="D":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationBas(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="D'":
		can.after(compteur*rFile("timeur","cub"),lambda:rotationBas(cube,can,face,faceSup,"gauche"))
	elif norme.upper()=="M":
		can.after(compteur*rFile("timeur","cub"),lambda:axe(cube,can,face,faceSup,"bas"))
	elif norme.upper()=="M'":
		can.after(compteur*rFile("timeur","cub"),lambda:axe(cube,can,face,faceSup,"haut"))
	elif norme.upper()=="E":
		can.after(compteur*rFile("timeur","cub"),lambda:axe(cube,can,face,faceSup,"droite"))
	elif norme.upper()=="E'":
		can.after(compteur*rFile("timeur","cub"),lambda:axe(cube,can,face,faceSup,"gauche"))
